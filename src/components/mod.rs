...
pub fn SiapaYangTau() -> impl IntoView {
  view! {
    <div class="flex flex-col items-center justify-center min-h-screen bg-[#0b0b0f] text-white">
      ...
      <a href="/" class="mt-3 relative inline-flex items-center gap-2 rounded-2xl px-5 py-3 bg-white/10 hover:bg-white/15 border border-white/10 hover:shadow-[0_0_25px_white]">{"Kembali"}</a>
    </div>
  }
}
